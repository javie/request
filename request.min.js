...
}else{if(b.indexOf(n,p[0])===true){q=p[0];}l=p[1];if(q!=="GET"){o=l.split("?");if(o.length>1){j=o[0];this.put("query",o[1]);}}l=l.replace(":baseUrl",this.get("baseUrl",""));
...
j=this;k=j.name;if(!b.isObject(m)){m=""+(e(this.get("object")).serialize())+"&"+(this.get("query"));if(m==="?&"){m="";}}this.executed=true;d.fire("Request.beforeSend",[this]);
