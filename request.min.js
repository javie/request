...
},e.prototype.put=function(e,t){var n;return n=e,u.isObject(e)||(n={},n[e]=t),this.config=u.defaults(n,this.config)},e.prototype.to=function(e,t,r){var i,s,f,p,l,c;
if(this.put({dataType:null!=r?r:r="json"}),f=["POST","GET","PUT","DELETE"],u.isUndefined(e))throw new Error("Missing required url parameter");return null==t&&(t=o.document),this.put({object:t}),p=e.split(" "),1===p.length?c=p[0]:(-1!==u.indexOf(f,p[0])&&(l=p[0]),c=p[1],"GET"!==l&&(s=c.split("?"),s.length>1&&(e=s[0],this.put({query:s[1]}))),c=c.replace(":baseUrl",this.get("baseUrl","")),this.put({type:l,uri:c})),i=n(this.get("object")).attr("id"),"undefined"!=typeof i&&this.put({id:"#"+i}),this
...
},t.put=function(e,t){var n;return n=e,u.isObject(e)||(n={},n[e]=t),this.config=u.defaults(n,this.config)},t}(),"undefined"!=typeof exports&&null!==exports?("undefined"!=typeof module&&null!==module&&module.exports&&(module.exports=t),o.Request=t):o.Javie.Request=t
}).call(this);