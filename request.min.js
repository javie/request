...
this.put({type:q,uri:l});}k=e(this.get("object")).attr("id");if(typeof k!=="undefined"){this.put({id:"#"+k});}return this;};h.prototype.execute=function(l){var k,j;
j=this;if(!b.isObject(l)){l=""+(e(this.get("object")).serialize())+"&"+(this.get("query"));if(l==="?&"){l="";}}this.executed=true;c.fire("Request.beforeSend",[this]);
c.fire("Request.beforeSend: "+name,[this]);this.config.beforeSend(this);k={type:this.get("type"),dataType:this.get("dataType"),url:this.get("uri"),data:l,complete:function(n){var m;
