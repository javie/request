...
return true;}};e.ajax(l);return this;};return j;})();c=(function(){function j(k){return j.make(k);}j.config={baseUrl:null,onError:function(l,k){},beforeSend:function(l,k){},onComplete:function(l,k){}};
...
k[l.toString()]=m;}return this.config=h.defaults(k,this.config);};j.make=function(k){if(!h.isString(k)){k="default";}return f(k);};return j;})();if(typeof exports!=="undefined"&&exports!==null){if((typeof module!=="undefined"&&module!==null)&&module.exports){module.exports=c;
}g.Request=c;}else{g.Javie.Request=c;}}).call(this);