...
n=["POST","GET","PUT","DELETE"];if(typeof j==="undefined"){throw new Error("Missing required url parameter");}if(m==null){m=a.document;}p=j.split(" ");
if(p.length===1){l=p[0];}else{if(b.indexOf(n,p[0])===true){q=p[0];}l=p[1];if(q!=="GET"){o=l.split("?");if(o.length>1){j=o[0];this.put("query",o[1]);}}l=l.replace(":baseUrl",this.get("baseUrl",""));
this.put({type:q,uri:l});}k=e(this.get("object")).attr("id");if(typeof k!=="undefined"){this.put({id:"#"+k});}return this;};h.prototype.execute=function(){var l,k,j;
