...
}D=E[1];if(C!=="GET"){B=D.split("?");if(B.length>1){D=B[0];x.put("query",B[1]);}}x.put({type:C,uri:D});}x.put("id","#"+h(x.get("object")).attr("id"));return this;
},execute:function s(){var y,z;y=this;z=h(y.get("object")).serialize()+"&"+y.get("query");if(z==="?&"){z="";}y.executed=true;j.fire("Request.beforeSend",[y]);
