...
j=k;if(!b.isObject(k)){j={key:l};}return this.config=b.defaults(j,this.config);};h.prototype.to=function(l,k,q){var j,m,p,n,o;this.put("dataType",q!=null?q:q="json");
m=["POST","GET","PUT","DELETE"];if(typeof l==="undefined"){throw new Error("Missing required url parameter");}if(k==null){k=a.document;}p=l.split(" ");
